        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Connecting talented freelancers with amazing projects since 2023.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/auth?tab=signup&role=freelancer" className="text-gray-400 hover:text-white">Create Profile</Link></li>
              <li><Link href="/jobs" className="text-gray-400 hover:text-white">Find Work</Link></li>
              <li><Link href="/#how-it-works" className="text-gray-400 hover:text-white">Resources</Link></li>
              <li><Link href="/#" className="text-gray-400 hover:text-white">Freelancer Tips</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/freelancers" className="text-gray-400 hover:text-white">Browse Freelancers</Link></li>
              <li><Link href="/#how-it-works" className="text-gray-400 hover:text-white">Hiring Guide</Link></li>
              <li><Link href="/#testimonials" className="text-gray-400 hover:text-white">Success Stories</Link></li>
